...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--runner", type=str, default="AnnealRunner", help="The runner to execute"
    )
    parser.add_argument(
        "--config", type=str, default="anneal.yml", help="Path to the config file"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="images",
        help="The directory of image outputs",
    )
